...
Try {
	...
	[string]$appVendor = 'SAS'
	[string]$appName = 'Foundation'
	[string]$appVersion = '9.4 M8'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '08/31/2023'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close SAS if needed, verify there is enough disk space to complete the install, and persist the prompt
		Show-InstallationWelcome -CloseApps 'sas' -CheckDiskSpace -PersistPrompt
		...
		## <Perform Installation tasks here>
			Execute-Process -Path "\\vmwfs14.winad.msudenver.edu\Lab\LabInstallers\SAS\setup.exe" -Parameters "-wait -quiet -responsefile `"\\vmwfs14.winad.msudenver.edu\Lab\LabInstallers\SAS\sdwresponse.properties`"" -WindowStyle 'Hidden' -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close SAS with a 60 second countdown before automatically closing
		Show-InstallationWelcome -CloseApps 'sas' -CloseAppsCountdown 60
		...
		# <Perform Uninstallation tasks here>
			Execute-Process -Path "C:\Program Files\SASHome\SASDeploymentManager\9.4\sasdm.exe" -Parameters "-quiet -uninstallall"
			Remove-Folder -Path "$envProgramFiles\SASHome"
			Remove-Folder -Path "$envProgramData\Microsoft\Windows\Start Menu\Programs\SAS\"
			Remove-Folder -Path "$envProgramData\SAS\"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQMbyCL4tpbY1s
# e+0o0kzCCNsYr4Hk8X8gW9sdwc3DaqCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBv/SqJVyqW6bhR
# 1M0Rt2QopQAK82ke474ZuxqVnkO8HjANBgkqhkiG9w0BAQEFAASCAYAQAtbBJSoD
# 6/elSucvwnrS0/Ano3E3h9Mizlyvg/5D57ZT2/VNssnnx5HcRIKRWQl61dXL5ivJ
# JJCUd2SRVJ+8RJl4Bq01zTNrKTdf4OfrbJ7A0Lf3tZQDUe5Ndl9dIVT76EutoP/h
# 457qAveuQJPHDEydDDNUQ8Zc3xeb6Xdgp56REvaGWvI+krVn24fKXwVpXS896bCp
# sCp3NEFZghbfJCBQq5zP2GidmmOFKddB7/TinLqxaROVjdDPifea8OWtAKnHHOEz
# RGxO+aAf4UwhQkIZwbMUq0UkfpVjN0Hu+ztAYKDx9RQjmGZmVcI8ri8X58T9Ngdb
# UH16UFi9PyzCKB7dYGAcAqvEFV5keob0tdqmbjBi4l/fFW/HRYsxAqi6PqmkdsK2
# SAZ/dgUQE6l2wTifHCGi5JaL3E0INtkRRZ6KWfMdmpfyk5kre511kRBKy7ig9oKD
# WQiI8JoZmucMgZPh2MyYBWEFLifEkUdsMeA/hLGixuXcmtTuY8AAgfyhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwODI1MjI1
# NDE4WjA/BgkqhkiG9w0BCQQxMgQwp/fdXgDvlLDwIkROyqJW8GKl/Peu8jbsVbl6
# +DbqlONxvXtH+3tp9Gsi/NKSs1CvMA0GCSqGSIb3DQEBAQUABIICAHSs6CcB+nbQ
# PBuLq1YA3jOtUrDeZiJrA3iGfLXsXwcjiKQJTlnD9W9snsLSMoB/TgJ4R17UJGIx
# Z+DRWP4ZNjfgMVzU+22VKg4ypSEvRduQ5EhEsNjxXwJGgdpimM9v+P2cr/ccunbb
# krG0+Y4bNETQ35ku6DMrnLxXxVxjA0QR4kINgdJv1g0cnekxYQv7e/bKSnt4Kgj+
# 7cfx/BpVUNhqeyC6yNnRVepOONfvsrTmwTbb8CfijP7F5dwco+rkJwPKYBYc/HCl
# io4VMsnm2oVOKOge8gTQhztMTnlG8okm7O0XX5ToGTxvqxCwqplF13gmPPXaAuON
# +DohAIAsuAOGJjQY+IU4ndVaEkgfUx+pf17Brj2C8M0fMmcj34DGsH0gFcY2hk/R
# 9IkDHP23v4vYKzvPtzBgj5wPr1l4KMY8R4U+TV3IEcd9vyPs5LrejKc1H3btllW9
# GGgQaIC8cAJYDYr3kSILJyZlqfQvorluwRdqClzsW0THUgo+vBxf7j15fYVJLJh5
# 2o6CvAwL+ofYHQ7xne8p5erh82PbBh7EBEtn0mJkceIRb6G/On+g1bxRXnK5iM3Z
# iWYQIpLoZQNFznlGKjbG77kiUwh0e2cm9ethvGAubFT/lxIlpOtrM5TilX5KoCD+
# zls75tG7Qf/khvKQiJVwT2DZwJTGYZ/9
